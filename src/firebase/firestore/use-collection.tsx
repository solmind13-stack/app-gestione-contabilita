...
export function useCollection<T = any>(
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (err: FirestoreError) => {
        // Se l'errore è dovuto ai permessi, emettiamo l'evento per il debug
        if (err.code === 'permission-denied') {
            ...
            // Per altri errori (es. connettività), impostiamo l'errore localmente senza triggerare il listener globale
            setError(err);
        }
